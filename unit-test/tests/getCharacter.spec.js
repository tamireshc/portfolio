...
describe('9 - Implemente os casos de teste da função `getCharacter`', () => {
  it('Verifica se  função, quando não recebe nenhum parâmetro, retorna undefined', () => {
    expect(getCharacter()).toBeUndefined();
  });
  it('Verifica se função retorna o objeto correto para o parâmetro "Arya"', () => {
  ...
  it('Verifica se função retorna o objeto correto para o parâmetro "Brienne"', () => {
  ...
  it('Verifica se função retorna o objeto correto para o parâmetro "Melissandre"', () => {
  ...
  it('Verifica ao passar um nome que não está na tabela, a função retorna undefined', () => {
    expect(getCharacter('xxxx')).toBeUndefined();
  });
});
